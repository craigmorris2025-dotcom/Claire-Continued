...
class LifecycleStageEngine:
        ...
        return [
            {
                ...
                "category": "knowledge",
                "output_key": "connector_sources",
            },
            {
                "stage": 2,
                "name": "Signal Extraction",
                "category": "knowledge",
                "output_key": "signal_trace",
            },
            {
                "stage": 3,
                "name": "Trend + Trajectory Modeling",
                "category": "discovery",
                "output_key": "trend_trajectory",
                "next_build": True,
            },
            {
                "stage": 4,
                "name": "Market / Sector / Industry Mapping",
                "category": "discovery",
                "output_key": "market_gap",
            },
            {
                "stage": 5,
                "name": "Gap Detection",
            ...
            },
            {
                ...
                "category": "discovery",
                "output_key": "opportunity_discovery",
                "next_build": True,
            },
            {
                "stage": 8,
                "name": "Breakthrough Synthesis",
            ...
            {
                "stage": 10,
                "name": "Market Formation Analysis",
                "category": "validation",
                "output_key": "market_formation",
                "next_build": True,
            },
            {
                "stage": 11,
            ...
            {
                "stage": 12,
                "name": "Risk / Regulation / Compliance",
                "category": "validation",
                "output_key": "risk_regulation",
                "next_build": True,
            },
            {
                "stage": 13,
                "name": "Productization Path",
                "category": "design",
                "output_key": "design_output",
            },
            {
                "stage": 14,
                "name": "Design Portal Routing",
                "category": "design",
                "output_key": "design_portal",
            },
            {
                "stage": 15,
                "name": "System / Technology Design Engine",
                "category": "design",
                "output_key": "design_output",
            },
            {
                "stage": 16,
                "name": "Technical Specs + Build Blueprint Generation",
                "category": "design",
                "output_key": "design_output",
            },
            {
            ...
            },
            {
                ...
                "category": "strategy",
                "output_key": "portfolio_binder",
            },
            {
                "stage": 19,
                "name": "Portfolio / Binder Assembly",
                "category": "portfolio",
                "output_key": "portfolio_binder",
            },
            {
                "stage": 20,
                "name": "Acquirer Discovery",
                "category": "outcome",
                "output_key": "acquirer_matches",
            },
            {
                "stage": 21,
                "name": "Deal / Exit Modeling",
                "category": "outcome",
                "output_key": "deal_modeling",
                "next_build": True,
            },
        ]
    ...
    def _stage_status(
        ...
        if stage == 1:
            ...
            status = "pending"
            evidence.append("dedicated trend_trajectory_engine not yet implemented")
        ...
        if status == "pending" and not evidence:
            evidence.append(f"{key or 'stage output'} not available")
    ...
    def _binder_has_section(self, binder: Dict[str, Any], section_id: str) -> bool:
        ...
        for section in binder.get("sections", []):
    ...
    def _next_recommended_stage(self, stages: List[Dict[str, Any]]) -> Dict[str, Any]:
        preferred_order = [3, 7, 10, 11, 12, 17, 21]
        ...
        for stage in stages:
            if stage["status"] == "pending":
                return {
                    "stage": stage["stage"],
                    "name": stage["name"],
                    "reason": "Next pending lifecycle stage.",
                }

        return {
            "stage": None,
            "name": "Lifecycle complete",
            "reason": "No pending lifecycle stages detected.",
        }
