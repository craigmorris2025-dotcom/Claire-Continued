class ConnectorHub:
    ...
    def __init__(self):
        ...
        try:
            from claire.connectors.market_connector import MarketConnector
            self.market = MarketConnector()
        except:
            self.market = None

        try:
            from claire.connectors.patent_connector import PatentConnector
            self.patent = PatentConnector()
        except:
            self.patent = None

        try:
            from claire.connectors.financial_connector import FinancialConnector
