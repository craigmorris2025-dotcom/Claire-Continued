"""
Safety governor — prevent recursive modification from breaking invariants

Version: 7.2.0
Module: src.claire.recursive.safety_governor
...
logger = logging.getLogger("claire.recursive")
...
class SafetyGovernor:
    ...
    def __init__(self):
        self.logger = logging.getLogger(
            f"claire.recursive.{type(self).__name__}"
        )
