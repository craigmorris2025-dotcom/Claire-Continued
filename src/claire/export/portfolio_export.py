"""
Portfolio export — structured output for external consumption

Version: 6.3.0
Module: src.claire.export.portfolio_export
...
logger = logging.getLogger("claire.export")
...
class PortfolioExport:
    ...
    def __init__(self):
        self.logger = logging.getLogger(
            f"claire.export.{type(self).__name__}"
        )
