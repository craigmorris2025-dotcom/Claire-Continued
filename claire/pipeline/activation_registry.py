...
PIPELINES: list[dict[str, Any]] = [
    {"id": "knowledge_ingestion", "label": "Knowledge Ingestion", "module": "claire.engines.knowledge_ingestion_engine", "class": "KnowledgeIngestionEngine"},
    {"id": "signal_extraction", "label": "Signal Extraction", "module": "claire.engines.signal_extraction_engine", "class": "SignalExtractionEngine"},
    {"id": "market_formation", "label": "Market Formation", "module": "claire.engines.market_formation_engine", "class": "MarketFormationEngine"},
    {"id": "market_gap", "label": "Market Gap", "module": "claire.engines.market_gap_engine", "class": "MarketGapEngine"},
    {"id": "breakthrough_synthesis", "label": "Breakthrough Synthesis", "module": "claire.engines.breakthrough_synthesis_engine", "class": "BreakthroughSynthesisEngine"},
    {"id": "technology_intelligence", "label": "Technology Intelligence", "module": "claire.technology.technology_intelligence", "class": "TechnologyIntelligenceLayer"},
    {"id": "technical_feasibility", "label": "Technical Feasibility", "module": "claire.engines.technical_feasibility_engine", "class": "TechnicalFeasibilityEngine"},
    {"id": "system_design", "label": "System Design", "module": "claire.engines.system_design_engine", "class": "SystemDesignEngine"},
    {"id": "auto_design", "label": "Auto Design", "module": "claire.engines.auto_design", "class": "AutoDesignEngine"},
    {"id": "portfolio_optimization", "label": "Portfolio Optimization", "module": "claire.portfolio.optimization_engine", "class": "PortfolioOptimizationEngine"},
    {"id": "acquirer_matching", "label": "Acquirer Matching", "module": "claire.engines.acquirer_matching", "class": "AcquirerMatchingEngine"},
    {"id": "productization_path", "label": "Productization Path", "module": "claire.engines.productization_path_engine", "class": "ProductizationPathEngine"},
    {"id": "deal_exit_modeling", "label": "Deal Exit Modeling", "module": "claire.engines.deal_exit_modeling_engine", "class": "DealExitModelingEngine"},
    {"id": "export_package", "label": "Export Package", "module": "claire.engines.export_package_engine", "class": "ExportPackageEngine"},
]
