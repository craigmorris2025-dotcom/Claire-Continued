...
def risk_pattern_registry() -> list[dict[str, Any]]:
    return [
        {
            "file": "claire/api/internet_controlled_live_probe_s394_s400.py",
            "risk": "urllib_network",
        ...
        {
            "file": "claire/audit/risk_pattern_governance_review.py",
            "risk": "subprocess",
        ...
        {
            "file": "claire/audit/system_plateau_audit.py",
            "risk": "subprocess",
        ...
        {
            "file": "claire/connectors/web_fetcher.py",
            "risk": "urllib_network",
        ...
        {
            "file": "claire/desktop/startup_reliability.py",
            "risk": "subprocess",
        ...
        {
            "file": "claire/enterprise/dependency_governance_snapshot.py",
            "risk": "subprocess",
        ...
        {
            "file": "claire/governance/governed_web/controlled_head_transport_executor.py",
            "risk": "urllib_network",
        ...
        {
            "file": "claire/install_safety/simple_manifest_installer.py",
            "risk": "subprocess",
        ...
        {
            "file": "claire/internet/governed_live_probe.py",
            "risk": "urllib_network",
        ...
        {
            "file": "claire/package_update_governance/dependency_snapshot.py",
            "risk": "subprocess",
        ...
        {
            "file": "claire/package_update_governance/pip_audit_runner.py",
            "risk": "subprocess",
        ...
        {
            "file": "claire/platform/launch_hardening.py",
            "risk": "subprocess",
        ...
        {
            "file": "claire/platform/manifest.py",
            "risk": "urllib_network",
        ...
        {
            "file": "claire/platform/resolver.py",
            "risk": "subprocess",
        ...
        {
            "file": "claire/real_governed_live_connectivity/http_client_adapter.py",
            "risk": "urllib_network",
