...
ENABLE_ENV = "CLAIRE_ALLOW_VISIBLE_QUERY_RESULT_VERIFICATION"
...
def _call_dashboard_smoke(query: str, manual_enable: bool, provider_health: Optional[Mapping[str, Any]]) -> Dict[str, Any]:
    ...
    try:
        from claire.governed_web.live_search_dashboard_smoke import execute_live_search_dashboard_smoke
