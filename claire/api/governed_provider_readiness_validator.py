...
from claire.api.governed_provider_configuration_contract import (
...
def get_governed_provider_readiness_validator() -> Dict[str, Any]:
    ...
    head_allowed = _flag_enabled("CLAIRE_ALLOW_CONTROLLED_HEAD_PROBE")
    metadata_get_allowed = _flag_enabled("CLAIRE_ALLOW_CONTROLLED_METADATA_GET")
    one_shot_allowed = _flag_enabled("CLAIRE_ALLOW_ONE_SHOT_METADATA_PROBE")
