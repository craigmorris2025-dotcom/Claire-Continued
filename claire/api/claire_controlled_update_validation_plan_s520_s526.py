...
def _load_sandbox_module():
    from claire.api import claire_staged_update_sandbox_contract_s513_s519 as sandbox_contract
...
def build_claire_controlled_update_validation_plan_s520_s526(project_root: str | Path | None = None) -> Dict[str, Any]:
    return _safe_base(
        "S520-S526",
...
__all__ = [
    ...
    "build_claire_controlled_update_validation_plan_s520_s526",
]
