...
def get_s35_provider_activation_verifier() -> Dict[str, Any]:
    provider = _env("CLAIRE_SEARCH_PROVIDER")
    ...
    gates = {
        ...
        "controlled_head_probe_allowed": _enabled("CLAIRE_ALLOW_CONTROLLED_HEAD_PROBE"),
        "one_shot_metadata_probe_allowed": _enabled("CLAIRE_ALLOW_ONE_SHOT_METADATA_PROBE"),
        "controlled_metadata_get_allowed": _enabled("CLAIRE_ALLOW_CONTROLLED_METADATA_GET"),
    }
