...
def _optional_import_status() -> list[dict[str, Any]]:
    candidates = (
        "claire.api.dashboard_search_provider_routes",
        "claire.api.search_provider_routes",
...
def _env_governance_state() -> dict[str, Any]:
    live_flags = {
        "CLAIRE_ALLOW_REAL_SEARCH_PROVIDER": os.getenv("CLAIRE_ALLOW_REAL_SEARCH_PROVIDER"),
        "CLAIRE_ALLOW_CONTROLLED_HEAD_PROBE": os.getenv("CLAIRE_ALLOW_CONTROLLED_HEAD_PROBE"),
        "CLAIRE_ALLOW_CONTROLLED_METADATA_GET": os.getenv("CLAIRE_ALLOW_CONTROLLED_METADATA_GET"),
        "CLAIRE_ALLOW_CONTROLLED_LIMITED_BODY_GET": os.getenv("CLAIRE_ALLOW_CONTROLLED_LIMITED_BODY_GET"),
    }
