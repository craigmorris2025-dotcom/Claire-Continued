...
def _provider_declared() -> bool:
    return bool(
        os.getenv("CLAIRE_SEARCH_PROVIDER")
        or os.getenv("CLAIRE_WEB_PROVIDER")
        or os.getenv("CLAIRE_PROVIDER_STATUS")
        or os.getenv("CLAIRE_ALLOW_REAL_SEARCH_PROVIDER")
    )

def build_operator_triggered_metadata_probe_endpoint_status() -> dict[str, Any]:
    provider_declared = _provider_declared()
    real_provider_allowed = _env_bool("CLAIRE_ALLOW_REAL_SEARCH_PROVIDER")
    head_probe_allowed = _env_bool("CLAIRE_ALLOW_CONTROLLED_HEAD_PROBE")
    metadata_probe_allowed = _env_bool("CLAIRE_ALLOW_CONTROLLED_METADATA_GET")
    one_shot_allowed = _env_bool("CLAIRE_ALLOW_ONE_SHOT_METADATA_PROBE")
    operator_trigger_allowed = _env_bool("CLAIRE_ALLOW_OPERATOR_TRIGGERED_METADATA_PROBE")
    allowlist_ready = _env_bool("CLAIRE_ALLOWLIST_READY") or _env_bool("CLAIRE_SOURCE_ALLOWLIST_READY")
    rate_limit_ready = _env_bool("CLAIRE_RATE_LIMIT_READY") or _env_bool("CLAIRE_RATE_LIMIT_POLICY_READY")
