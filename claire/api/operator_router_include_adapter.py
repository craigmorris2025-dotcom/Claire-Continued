...
from claire.api.operator_read_only_router import OPERATOR_ROUTE_PATHS, router as operator_router
...
def discover_app_factory(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return flatten_governance({"discovered": True, "factory": "claire.app:create_app", "app_factory": "claire.app:create_app", "app_module": "claire.app", "app_attribute": "create_app", "integration_mode": "non_invasive_include_adapter"})

def discover_operator_router(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return flatten_governance({"discovered": True, "router_module": "claire.api.operator_read_only_router", "router_attribute": "router", "route_count": len(OPERATOR_ROUTE_PATHS), "routes": list(OPERATOR_ROUTE_PATHS)})
...
def discover_app_factory(*args, **kwargs) -> dict:
    return flatten_compat({
        ...
        "app_factory": "claire.app:create_app",
