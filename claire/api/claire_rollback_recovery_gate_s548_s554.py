...
def build_s554_stop_gate(report_dir: str | Path | None = None, project_root: str | Path | None = None) -> Dict[str, Any]:
    ...
    result_intake = __import__(
        "claire.api.claire_validation_result_intake_s534_s540",
        fromlist=["claire_validation_result_intake_s534_s540"],
    )
...
def build_claire_rollback_recovery_gate_s548_s554(project_root: str | Path | None = None) -> Dict[str, Any]:
    return _safe_base(
        "S548-S554",
...
__all__ = [
    ...
    "build_claire_rollback_recovery_gate_s548_s554",
]
