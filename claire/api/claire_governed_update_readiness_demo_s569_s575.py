...
def _load_modules() -> Dict[str, Any]:
    from claire.api import claire_governed_update_inspector_s506_s512 as inspector
    from claire.api import claire_staged_update_sandbox_contract_s513_s519 as sandbox
    ...
    from claire.api import claire_operator_staged_update_handoff_s555_s561 as handoff
    from claire.api import claire_update_control_cockpit_wiring_s562_s568 as cockpit
...
def build_claire_governed_update_readiness_demo_s569_s575(project_root: str | Path | None = None) -> Dict[str, Any]:
    return _safe_base(
        "S569-S575",
...
__all__ = [
    ...
    "build_claire_governed_update_readiness_demo_s569_s575",
]
