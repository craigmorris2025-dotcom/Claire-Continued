...
def _load_response_card_module():
    from claire.api import claire_command_response_cards_s457_s463 as response_cards
...
def build_claire_evidence_backed_answer_model_s464_s470(project_root: str | Path | None = None) -> Dict[str, Any]:
    return _safe_base(
        "S464-S470",
...
__all__ = [
    ...
    "build_claire_evidence_backed_answer_model_s464_s470",
]
