"""
Dashboard data generator — real-time system metrics

Version: 6.3.0
Module: src.claire.dashboard.generator
...
logger = logging.getLogger("claire.dashboard")
...
class Generator:
    ...
    def __init__(self):
        self.logger = logging.getLogger(
            f"claire.dashboard.{type(self).__name__}"
        )
