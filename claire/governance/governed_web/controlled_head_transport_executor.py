...
ENABLE_ENV_VAR = "CLAIRE_ALLOW_CONTROLLED_HEAD_PROBE"
...
def build_dashboard_controlled_head_executor_payload(query: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "ui_notice": "Controlled HEAD executor installed. Real network call requires CLAIRE_ALLOW_CONTROLLED_HEAD_PROBE=1.",
    }
