...
```json
{
  "current_state": "needs_control_burndown",
...
```json
"defense autonomy is research_only with research_ready productization strength and a score of 0.4386. The recommended motion is controlled validation pilot with launch posture advisory_or_shadow_mode_before_automation. Productization should focus on a narrow product wedge, measurable buyer value, workflow adoption, and evidence gates before enterprise expansion."
```
