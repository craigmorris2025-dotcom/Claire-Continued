...
{
  "key_scores": {
    "breakthrough": 0.9440000000000001,
    "confidence": 0.7380816201361666,
    "feasibility": 0.6827518003953834,
    "knowledge_quality": 0.7798,
    "portfolio": 0.7380816201361666,
    "productization": 0.5859,
    "signal_quality": 0.6363,
    "strategic_positioning": 0.6902
  },
  "summary": "Claire identified a distributed autonomous decision platform opportunity. Defense operators need secure, human-reviewed autonomy and mission intelligence under contested, low-latency conditions. The needed solution is: Distributed autonomous decision platform with secure command integration, simulation data, auditability, and human override controls. Knowledge ingestion is strong with score 0.7798, 3 source(s), and broad coverage. Signal extraction identifies defense autonomy with usable signal quality and routing confidence of 0.745. Opportunity discovery classifies this as a strong validated gap opportunity with medium priority and moderate validation urgency. Breakthrough synthesis classifies this as innovation candidate with innovation_candidate synthesis strength and weak non-obviousness. Technical feasibility classifies this as conditionally feasible with earl
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-07T06:52:23.570106+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "technology",
...
```json
{
  ...
  "breakthrough_thesis": "defense autonomy is classified as a innovation candidate. The breakthrough mechanism is: convert sensor and mission context into authorized, explainable
... [truncated]
```
...
```json
{
  ...
  "buyer_positioning": {
    ...
    "economic_buyer_message": "Start with a controlled validation pilot that measures time-to-decision, operator acceptance, and coordination-
... [truncated]
```
...
```json
{
  "breakthrough_score": 0.9440000000000001,
  "innovation_score": 0.8196486563081724,
  ...
  "signal_trace": {
    ...
    "analysis": 0.9095325760829623,
    "architecture_readiness_score": 0.5831,
    "blocker_level": "conditional",
    "breakthrough_base": 0.7474407080076072,
    "breakthrough_final": 0.9440000000000001,
    "breakthrough_mechanism_score": 0.6287,
    "breakthrough_spike": 0.255,
    "breakthrough_synthesis_confidence": 0.718,
    "breakthrough_synthesis_score": 0.7374,
...
```json
{
  ...
  "needed_solution": "Distributed autonomous decision platform with secure command integration, simulation data, auditability, and human override controls.",
  "performance_targets": {
    "breakthrough_intensity": 0.944,
    "feasibility_threshold": 0.6828,
    "portfolio_confidence": 0.7381
  },
...
```json
{
  "buildability_score": 0.7132967313098298,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.6827518003953834,
  "readiness": {
    "breakthrough": 0.9440000000000001,
    "feasibility": 0.6827518003953834,
    "portfolio": 0.7380816201361666,
  ...
  "risk_notes": [
    ...
    "Deal/exit model shows exit_candidate_with_conditions with strong
... [truncated]
```
...
```json
{
  "acquisition_score": 0.6997622927242755,
  "matching_score": 0.7052200473053963,
  "portfolio_score": 0.7380816201361666,
