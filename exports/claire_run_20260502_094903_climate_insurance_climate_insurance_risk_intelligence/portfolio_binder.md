...
```json
{
  "key_scores": {
    ...
    "confidence": 0.8366111445186236,
    "feasibility": 0.7570091164099425,
    "knowledge_quality": 0.6616,
    "portfolio": 0.8366111445186236,
    "productization": 0.6467,
    "signal_quality": 0.331,
    "strategic_positioning": 0.7197
  },
...
```json
{
  ...
  "ingested_at": "2026-05-02T09:49:03.468888+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "insurance",
...
```json
{
  ...
  "breakthrough_thesis": "climate in
... [truncated]
```
...
```json
{
  ...
  "data_readiness": {
    ...
    "data_rights_notes": "Data rights must cover exposu
... [truncated]
```
...
```json
{
  ...
  "innovation_score": 0.820724109676856,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.2670; market pressure contribution was 0.6096; trajectory inevitability was 0.7599; category creation was 0.7596; buyer pull was 0.7144; moat score was 0.5846; risk score was 0.3941; value capture was 0.6439; buyer ROI was 0.5486.",
  "signal_trace": {
    "acquirer_positioning_score": 0.98,
    "analysis": 0.5838837929199803,
    "architecture_readiness_score": 0.5629,
    "blocker_level": "low",
    "breakthrough_base": 0.7375684935918582,
    "breakthrough_final": 0.9440000000000001,
    "breakthrough_mechanism_score": 0.6492,
    "breakthrough_spike": 0.267,
    "breakthrough_synthesis_confidence": 0.7436,
    "breakthrough_synthesis_score": 0.7758,
    "business_model_confidence": 0.6747,
    "buyer_pull_score": 0.7144,
    "buyer_roi_score": 0.5486,
    "category_creation_score": 0.7596,
    "commercial_risk_score": 0.218,
    "control_signal_score": 0.06,
    "copy_risk_score": 0.3005,
    "coverage_score": 0.8985,
    "data_readiness_score": 0.3397,
    "deal_exit_confidenc
... [truncated]
```
...
```json
{
  "buildability_score": 0.7682604680142218,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.7570091164099425,
  "readiness": {
    "breakthrough": 0.9440000000000001,
    "feasibility": 0.7570091164099425,
    "portfolio": 0.8366111445186236,
...
```json
{
  "acquisition_score": 0.7793167941284332,
  "matching_score": 0.7772036956672939,
  "portfolio_score": 0.8366111445186236,
