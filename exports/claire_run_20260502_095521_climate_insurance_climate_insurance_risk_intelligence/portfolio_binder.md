...
```json
{
  "key_scores": {
    ...
    "confidence": 0.8843058691530716,
    "feasibility": 0.7859865239419696,
    "knowledge_quality": 0.6696,
    "portfolio": 0.8843058691530716,
    "productization": 0.6826,
    "signal_quality": 0.348,
    "strategic_positioning": 0.7647
  },
  "summary": "Claire identified a climate insurance risk intelligence platform opportunity. Insurers and reinsurers face accelerating climate exposure, property-risk concentration, pricing uncertainty, and withdrawal pressure before underwriting systems fully adapt. The needed solution is: Climate insurance risk intelligence platform that detects exposure concentration, forecasts repricing pressure, and supports underwriting, risk-transfer, and portfolio countermeasures. Knowledge ingestion is usable with score 0.6696, 3 source(s), and broad coverage. Signal extraction identifies climate insurance with weak signal quality and routing confidence of 0.3325. Opportunity discovery classifies this as a exceptional urgent buyer pain opportunity with high priority and high validation urgency. Breakthrough synthesis classifies this as breakthrough candidate with strategic_breakthrough syn
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-02T09:55:21.768614+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "insurance",
...
```json
{
  "adoption_curve_position": {
    "adoption_pressure": 0.778,
    "maturity_score": 0.554,
...
```json
{
  ...
  "discovery_vector": {
    ...
    "opportunity_type": "urgent_buyer_pain_opportunity",
...
```json
{
  ...
  "breakthrough_mechanism": {
    ...
    "mechanism_score": 0.6961,
    "mechanism_type": "timing_window_breakthrough",
...
```json
{
  ...
  "innovation_score": 0.8492103807965421,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.4120; market pressure contribution was 0.7096; trajectory inevitability was 0.8112; category creation was 0.8526; buyer pull was 0.8382; moat score was 0.6176; risk score was 0.3941; value capture was 0.6955; buyer ROI was 0.5941.",
  "signal_trace": {
    "acquirer_positioning_score": 0.98,
    "analysis": 0.5838837929199803,
    "architecture_readiness_score": 0.5677,
    "blocker_level": "low",
    "breakthrough_base": 0.7804084075141883,
    "breakthrough_final": 0.9440000000000001,
    "breakthrough_mechanism_score": 0.6961,
    "breakthrough_spike": 0.41200000000000014,
    "breakthrough_synthesis_confidence": 0.79,
    "breakthrough_synthesis_score": 0.8396,
    "business_model_confidence": 0.7261,
    "buyer_pull_score": 0.8382,
    "buyer_roi_score": 0.5941,
    "category_creation_score": 0.8526,
    "commercial_risk_score": 0.208,
    "control_signal_score": 0.06,
    "copy_risk_score": 0.285,
    "coverage_score": 0.9045,
    "data_readiness_score": 0.3473,
    "deal_ex
... [truncated]
```
...
```json
{
  "buildability_score": 0.7981617634165314,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.7859865239419696,
  "readiness": {
    "breakthrough": 0.9440000000000001,
    "feasibility": 0.7859865239419696,
    "portfolio": 0.8843058691530716,
