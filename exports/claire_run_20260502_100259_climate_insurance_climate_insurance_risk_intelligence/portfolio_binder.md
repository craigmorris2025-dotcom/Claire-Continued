...
```json
{
  "key_scores": {
    ...
    "confidence": 0.8574764963230543,
    "feasibility": 0.770283775218861,
    "knowledge_quality": 0.6672,
    "portfolio": 0.8574764963230543,
    "productization": 0.6623,
    "signal_quality": 0.3351,
    "strategic_positioning": 0.7389
  },
  "summary": "Claire identified a climate insurance risk intelligence platform opportunity. Insurers and reinsurers face accelerating climate exposure, property-risk concentration, pricing uncertainty, and withdrawal pressure before underwriting systems fully adapt. The needed solution is: Climate insurance risk intelligence platform that detects exposure concentration, forecasts repricing pressure, and supports underwriting, risk-transfer, and portfolio countermeasures. Knowledge ingestion is usable with score 0.6672, 3 source(s), and broad coverage. Signal extraction identifies climate insurance with weak signal quality and routing confidence of 0.2913. Opportunity discovery classifies this as a strong validated gap opportunity with high priority and high validation urgency. Breakthrough synthesis classifies this as breakthrough candidate with strategic_breakthrough synthesis st
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-02T10:02:59.413430+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "insurance",
...
```json
{
  ...
  "innovation_score": 0.8328370405110724,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.3220; market pressure contribution was 0.6596; trajectory inevitability was 0.7107; category creation was 0.8192; buyer pull was 0.8050; moat score was 0.5816; risk score was 0.3941; value capture was 0.6770; buyer ROI was 0.5758.",
  "signal_trace": {
    "acquirer_positioning_score": 0.98,
    "analysis": 0.5838837929199803,
    "architecture_readiness_score": 0.5651,
    "blocker_level": "low",
    "breakthrough_base": 0.7564751209955056,
    "breakthrough_final": 0.9440000000000001,
    "breakthrough_mechanism_score": 0.6696,
    "breakthrough_spike": 0.32200000000000006,
    "breakthrough_synthesis_confidence": 0.7706,
    "breakthrough_synthesis_score": 0.8137,
    "business_model_confidence": 0.7087,
    "buyer_pull_score": 0.805,
    "buyer_roi_score": 0.5758,
    "category_creation_score": 0.8192,
    "commercial_risk_score": 0.2118,
    "control_signal_score": 0.06,
    "copy_risk_score": 0.3153,
    "coverage_score": 0.9029,
    "data_readiness_score": 0.3438,
    "deal
... [truncated]
```
...
```json
{
  "buildability_score": 0.7820687375438911,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.770283775218861,
  "readiness": {
    "breakthrough": 0.9440000000000001,
    "feasibility": 0.770283775218861,
    "portfolio": 0.8574764963230543,
...
```json
{
  "acquisition_score": 0.7994606439428342,
  "matching_score": 0.7980833339496259,
  "portfolio_score": 0.8574764963230543,
