...
```json
{
  "key_scores": {
    ...
    "confidence": 0.8993746702597157,
    "feasibility": 0.7948721036312979,
    "knowledge_quality": 0.8454,
    "portfolio": 0.8993746702597157,
    "productization": 0.7569,
    "signal_quality": 0.6731,
    "strategic_positioning": 0.838
  },
  "summary": "Claire identified a climate insurance risk intelligence platform opportunity. Insurers and reinsurers face accelerating climate exposure, property-risk concentration, pricing uncertainty, and withdrawal pressure before underwriting systems fully adapt. The needed solution is: Climate insurance risk intelligence platform that detects exposure concentration, forecasts repricing pressure, and supports underwriting, risk-transfer, and portfolio countermeasures. Knowledge ingestion is strong with score 0.8454, 3 source(s), and broad coverage. Signal extraction identifies climate insurance with usable signal quality and routing confidence of 0.5388. Opportunity discovery classifies this as a exceptional platform wedge with high priority and high validation urgency. Breakthrough synthesis classifies this as breakthrough with category_breakthrough synthesis strength and mode
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-05T14:08:52.800475+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "insurance",
...
```json
{
  "adoption_curve_position": {
    "adoption_pressure": 0.748,
    "maturity_score": 0.584,
  ...
  "evidence_signals": {
    ...
    "sector": "climate_insurance",
    "strategic_pressure_score": 0.7096,
...
```json
{
  ...
  "innovation_score": 0.8597315510076252,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.4370; market pressure contribution was 0.7096; trajectory inevitability was 0.7312; category creation was 0.9052; buyer pull was 0.7920; moat score was 0.7966; risk score was 0.3941; value capture was 0.7185; buyer ROI was 0.5774.",
  "signal_trace": {
    "acquirer_positioning_score": 0.98,
    "analysis": 0.5838837929199803,
    "architecture_readiness_score": 0.6092,
    "blocker_level": "low",
    "breakthrough_base": 0.7876611438583142,
    "breakthrough_final": 0.9440000000000001,
    "breakthrough_mechanism_score": 0.7165,
    "breakthrough_spike": 0.43700000000000017,
    "breakthrough_synthesis_confidence": 0.8146,
    "breakthrough_synthesis_score": 0.8909,
    "business_model_confidence": 0.7445,
    "buyer_pull_score": 0.792,
    "buyer_roi_score": 0.5774,
    "category_creation_score": 0.9052,
    "commercial_risk_score": 0.2041,
    "control_signal_score": 0.225,
    "copy_risk_score": 0.1164,
    "coverage_score": 0.96,
    "data_readiness_score": 0.5271,
    "deal_
... [truncated]
```
...
```json
{
  "buildability_score": 0.8076255822101701,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.7948721036312979,
  "readiness": {
    "breakthrough": 0.9440000000000001,
    "feasibility": 0.7948721036312979,
    "portfolio": 0.8993746702597157,
  ...
  "technical_feasibility": {
    "architecture_readiness": {
      "architecture_notes": "Climate-insurance feasibility depends on loss-history quality, exposure data lineage, s
... [truncated]
```
...
```json
{
  "acquisition_score": 0.8377732000079061,
  "matching_score": 0.8305470599966578,
  "portfolio_score": 0.8993746702597157,
