...
```json
{
  "key_scores": {
    ...
    "confidence": 0.8588070252523458,
    "feasibility": 0.7704406663795684,
    "knowledge_quality": 0.6705,
    "portfolio": 0.8588070252523458,
    "productization": 0.6644,
    "signal_quality": 0.3422,
    "strategic_positioning": 0.7415
  },
  "summary": "Claire identified a climate insurance risk intelligence platform opportunity. Insurers and reinsurers face accelerating climate exposure, property-risk concentration, pricing uncertainty, and withdrawal pressure before underwriting systems fully adapt. The needed solution is: Climate insurance risk intelligence platform that detects exposure concentration, forecasts repricing pressure, and supports underwriting, risk-transfer, and portfolio countermeasures. Knowledge ingestion is usable with score 0.6705, 3 source(s), and broad coverage. Signal extraction identifies climate insurance with weak signal quality and routing confidence of 0.2913. Opportunity discovery classifies this as a exceptional validated gap opportunity with high priority and high validation urgency. Breakthrough synthesis classifies this as breakthrough candidate with strategic_breakthrough synthe
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-02T10:13:51.072112+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "insurance",
    ...
    "safe_for_downstream_scoring": tru
... [truncated]
```
  ...
  "recommended_downstream_attention": [
    {
      ...
      "priority": "medium",
      "reason": "input has limited specificit
... [truncated]
```
...
```json
{
  "adoption_curve_position": {
    "adoption_pressure": 0.762,
    "maturity_score": 0.551,
  ...
  "evidence_signals": {
    ...
    "sector": "climate_insurance",
    "strategic_pressure_score": 0.6596,
...
```json
{
  "breakthrough_classification": {
    ...
    "classification": "breakthrough_candidate",
    "confidence_band": "high",
    "readiness_modifier": "advancable",
    "synthesis_score_used": 0.8219
  },
...
```json
{
  ...
  "innovation_score": 0.8339077912426774,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.3220; market pressure contribution was 0.6596; trajectory inevitability was 0.7107; category creation was 0.8492; buyer pull was 0.8050; moat score was 0.5704; risk score was 0.3941; value capture was 0.6790; buyer ROI was 0.5758.",
  "signal_trace": {
    "acquirer_positioning_score": 0.98,
    "analysis": 0.5838837929199803,
    "architecture_readiness_score": 0.5652,
    "blocker_level": "low",
    "breakthrough_base": 0.758365296914391,
    "breakthrough_final": 0.9440000000000001,
    "breakthrough_mechanism_score": 0.6732,
    "breakthrough_spike": 0.32200000000000006,
    "breakthrough_synthesis_confidence": 0.7742,
    "breakthrough_synthesis_score": 0.8219,
    "business_model_confidence": 0.711,
    "buyer_pull_score": 0.805,
    "buyer_roi_score": 0.5758,
    "category_creation_score": 0.8492,
    "commercial_risk_score": 0.2122,
    "control_signal_score": 0.06,
    "copy_risk_score": 0.3337,
    "coverage_score": 0.9054,
    "data_readiness_score": 0.3432,
    "deal_e
... [truncated]
```
...
```json
{
  "buildability_score": 0.782266886823241,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.7704406663795684,
  "readiness": {
    "breakthrough": 0.9440000000000001,
    "feasibility": 0.7704406663795684,
    "portfolio": 0.8588070252523458,
  ...
  "technical_feasibility": {
    "architecture_readiness": {
      "architecture_notes": "Climate-insurance feasibility depends on loss-history quality, exposur
... [truncated]
```
...
```json
{
  "acquisition_score": 0.8006260352022995,
  "matching_score": 0.7990816875820221,
  "portfolio_score": 0.8588070252523458,
  "positioning": "This opportunity is positioned in climate insurance. It addresses the needed solution: Climate insurance risk intelligence platform that detects exposure concentration, forecasts repricing pressure, and supports underwriting, risk-transfer, and portfolio countermeasures. Primary buyer segments include insurers, reinsurers, underwriting teams. The trend trajectory is rising, with a near term strategic window. Market formation profile: category expansion at early adoption stage. Defensibility is moderate, led by workflow lock in. Risk profile is low, regulatory exposure is low, and blocker level is low. Business model fit is enterprise subscription with moderate value capture. Deal/exit position is exit candidate with strong strategic fit and strategic with validation valuation signal."
}
```
