...
```json
{
  "key_scores": {
    ...
    "confidence": 0.8667276379140231,
    "feasibility": 0.777370772154617,
    "knowledge_quality": 0.685,
    "portfolio": 0.8667276379140231,
    "productization": 0.6571,
    "signal_quality": 0.3898,
    "strategic_positioning": 0.7434
  },
  "summary": "Claire identified a climate insurance risk intelligence platform opportunity. Insurers and reinsurers face accelerating climate exposure, property-risk concentration, pricing uncertainty, and withdrawal pressure before underwriting systems fully adapt. The needed solution is: Climate insurance risk intelligence platform that detects exposure concentration, forecasts repricing pressure, and supports underwriting, risk-transfer, and portfolio countermeasures. Knowledge ingestion is usable with score 0.685, 3 source(s), and broad coverage. Signal extraction identifies climate insurance with thin signal quality and routing confidence of 0.415. Opportunity discovery classifies this as a exceptional validated gap opportunity with high priority and high validation urgency. Breakthrough synthesis classifies this as breakthrough candidate with strategic_breakthrough synthesis 
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-05T14:42:02.452651+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "insurance",
...
```json
{
  ...
  "recommended_downstream_attention": [
    {
      "area": "input quality",
      "downstream_use": "treat discovery and breakthrough conclusions as e
... [truncated]
```
...
```json
{
  ...
  "innovation_score": 0.8395412088549054,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.3620; market pressure contribution was 0.7096; trajectory inevitability was 0.7312; category creation was 0.7852; buyer pull was 0.7920; moat score was 0.6321; risk score was 0.3941; value capture was 0.6811; buyer ROI was 0.5774.",
  "signal_trace": {
    "acquirer_positioning_score": 0.98,
    "analysis": 0.5838837929199803,
    "architecture_readiness_score": 0.5464,
    "blocker_level": "low",
    "breakthrough_base": 0.7614125657902564,
    "breakthrough_final": 0.9440000000000001,
    "breakthrough_mechanism_score": 0.6729,
    "breakthrough_spike": 0.3620000000000001,
    "breakthrough_synthesis_confidence": 0.7759,
    "breakthrough_synthesis_score": 0.8254,
    "business_model_confidence": 0.7104,
    "buyer_pull_score": 0.792,
    "buyer_roi_score": 0.5774,
    "category_creation_score": 0.7852,
    "commercial_risk_score": 0.2106,
    "control_signal_score": 0.06,
    "copy_risk_score": 0.2677,
    "coverage_score": 0.9164,
    "data_readiness_score": 0.3881,
    "deal_
... [truncated]
```
...
```json
{
  "buildability_score": 0.7898778906275203,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.777370772154617,
  "readiness": {
    "breakthrough": 0.9440000000000001,
    "feasibility": 0.777370772154617,
    "portfolio": 0.8667276379140231,
