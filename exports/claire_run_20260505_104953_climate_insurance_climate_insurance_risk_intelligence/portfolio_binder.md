...
```json
{
  "key_scores": {
    ...
    "confidence": 0.9330538431847227,
    "feasibility": 0.8374280942428,
    "knowledge_quality": 0.7555,
    "portfolio": 0.9330538431847227,
    "productization": 0.7264,
    "signal_quality": 0.5467,
    "strategic_positioning": 0.8283
  },
  "summary": "Claire identified a climate insurance risk intelligence platform opportunity. Insurers and reinsurers face accelerating climate exposure, property-risk concentration, pricing uncertainty, and withdrawal pressure before underwriting systems fully adapt. The needed solution is: Climate insurance risk intelligence platform that detects exposure concentration, forecasts repricing pressure, and supports underwriting, risk-transfer, and portfolio countermeasures. Knowledge ingestion is strong with score 0.7555, 3 source(s), and broad coverage. Signal extraction identifies climate insurance with thin signal quality and routing confidence of 0.6212. Opportunity discovery classifies this as a exceptional platform wedge with immediate priority and high validation urgency. Breakthrough synthesis classifies this as breakthrough with category_breakthrough synthesis strength and mod
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-05T10:49:53.890040+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "insurance",
...
```json
{
  "adoption_curve_position": {
    "adoption_pressure": 0.7624,
    "maturity_score": 0.649,
  ...
  "evidence_signals": {
    ...
    "sector": "climate_insurance",
    "strategic_pressure_score": 0.7696,
...
```json
{
  ...
  "breakthrough_mechanism": {
    ...
    "mechanism_score": 0.7272,
    "mechanism_type": "platform_plus_data_moat",
  ...
  "breakthrough_synthesis_score": {
    "drivers": [
      ...
      "strong defensibility signal",
      "input describes hidden 
... [truncated]
```
...
```json
{
  ...
  "data_readiness": {
    ...
    "data_rights_notes": "Data rights must cover exposur
... [truncated]
```
...
```json
{
  ...
  "innovation_score": 0.9239253293401383,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.3970; market pressure contribution was 0.7696; trajectory inevitability was 0.7492; category creation was 0.9354; buyer pull was 0.8122; moat score was 0.8058; risk score was 0.3941; value capture was 0.7271; buyer ROI was 0.5840.",
  "signal_trace": {
    "acquirer_positioning_score": 0.98,
    "analysis": 0.5838837929199803,
    "architecture_readiness_score": 0.616,
    "blocker_level": "low",
    "breakthrough_base": 0.884041844653346,
    "breakthrough_final": 0.9440000000000001,
    "breakthrough_mechanism_score": 0.7272,
    "breakthrough_spike": 0.39700000000000013,
    "breakthrough_synthesis_confidence": 0.8247,
    "breakthrough_synthesis_score": 0.9155,
    "business_model_confidence": 0.7525,
    "buyer_pull_score": 0.8122,
    "buyer_roi_score": 0.584,
    "category_creation_score": 0.9354,
    "commercial_risk_score": 0.2023,
    "control_signal_score": 0.225,
    "copy_risk_score": 0.0707,
    "coverage_score": 0.96,
    "data_readiness_score": 0.4516,
    "deal_ex
... [truncated]
```
...
```json
{
  "buildability_score": 0.8499272395306008,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.8374280942428,
  "readiness": {
    "breakthrough": 0.9440000000000001,
    "feasibility": 0.8374280942428,
    "portfolio": 0.9330538431847227,
  ...
  "technical_feasibility": {
    "architecture_readiness": {
      "architecture_notes": "Climate-insurance feasibility depends on loss-history quality, exposure data lineage, scenari
... [truncated]
```
