...
```json
{
  ...
  "level": "strong",
  "score": 0.8087,
  "strategic_rationale": "defense autonomy has deep strategic-buyer coverage, top acquirer score of 0.9800, buyer pull of 0.7151, and value capture of 0.6259."
}
```
...
```json
{
  ...
  "one_liner": "A defense autonomy opportunity with strong strategic fit, deep buyer coverage, and strategic_with_validation valuation signal."
}
```
...
```json
"defense autonomy is a exit_candidate_with_conditions with strong strategic fit and strategic_with_validation valuation signal."
```
