...
```json
{
  ...
  "evidence_signals": {
    ...
    "buyer_pull_strength": "weak_or_unproven",
...
```json
{
  ...
  "domain": "general",
  "evidence_signals": {
    "analysis_score": 0.36365957335569427,
