...
```json
{
  "key_scores": {
    ...
    "confidence": 0.9130768187010854,
    "feasibility": 0.8028395634110929,
    "knowledge_quality": 0.8418,
    "portfolio": 0.9130768187010854,
    "productization": 0.7124,
    "signal_quality": 0.5804,
    "strategic_positioning": 0.8157
  },
  "summary": "Claire identified a climate insurance risk intelligence platform opportunity. Insurers and reinsurers face accelerating climate exposure, property-risk concentration, pricing uncertainty, and withdrawal pressure before underwriting systems fully adapt. The needed solution is: Climate insurance risk intelligence platform that detects exposure concentration, forecasts repricing pressure, and supports underwriting, risk-transfer, and portfolio countermeasures. Knowledge ingestion is strong with score 0.8418, 3 source(s), and broad coverage. Signal extraction identifies climate insurance with usable signal quality and routing confidence of 0.4975. Opportunity discovery classifies this as a exceptional platform wedge with immediate priority and high validation urgency. Breakthrough synthesis classifies this as breakthrough with category_breakthrough synthesis strength an
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-05T14:46:52.970439+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "insurance",
...
```json
{
  "adoption_curve_position": {
    "adoption_pressure": 0.76,
    "maturity_score": 0.619,
  ...
  "evidence_signals": {
    ...
    "sector": "climate_insurance",
    "strategic_pressure_score": 0.7596,
...
```json
{
  ...
  "innovation_score": 0.8675819745918087,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.4770; market pressure contribution was 0.7596; trajectory inevitability was 0.8262; category creation was 0.9173; buyer pull was 0.8200; moat score was 0.7862; risk score was 0.3941; value capture was 0.7236; buyer ROI was 0.5912.",
  "signal_trace": {
    "acquirer_positioning_score": 0.98,
    "analysis": 0.5838837929199803,
    "architecture_readiness_score": 0.5705,
    "blocker_level": "low",
    "breakthrough_base": 0.8002967527071769,
    "breakthrough_final": 0.9440000000000001,
    "breakthrough_mechanism_score": 0.7287,
    "breakthrough_spike": 0.4770000000000001,
    "breakthrough_synthesis_confidence": 0.8208,
    "breakthrough_synthesis_score": 0.9032,
    "business_model_confidence": 0.7492,
    "buyer_pull_score": 0.82,
    "buyer_roi_score": 0.5912,
    "category_creation_score": 0.9173,
    "commercial_risk_score": 0.2025,
    "control_signal_score": 0.06,
    "copy_risk_score": 0.1332,
    "coverage_score": 0.96,
    "data_readiness_score": 0.4646,
    "deal_exi
... [truncated]
```
...
```json
{
  "buildability_score": 0.8155341948409263,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.8028395634110929,
  "readiness": {
    "breakthrough": 0.9440000000000001,
    "feasibility": 0.8028395634110929,
    "portfolio": 0.9130768187010854,
...
```json
{
  "acquisition_score": 0.8496266472380677,
  "matching_score": 0.8376221651244741,
  "portfolio_score": 0.9130768187010854,
