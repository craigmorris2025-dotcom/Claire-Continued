...
{
  "key_scores": {
    "breakthrough": 0.8422336823385653,
    "confidence": 0.696429200514279,
    "feasibility": 0.6578819485783239,
    "knowledge_quality": 0.5491,
    "portfolio": 0.696429200514279,
    "productization": 0.4495,
    "signal_quality": 0.2548,
    "strategic_positioning": 0.5355
  },
  "summary": "Claire identified a opportunity intelligence platform opportunity. Organizations lack integrated systems for detecting weak signals, synthesizing opportunities, and converting them into validated designs. The needed solution is: Cross-sector opportunity intelligence platform that maps signals, gaps, opportunities, designs, and strategic outcomes. Knowledge ingestion is limited with score 0.5491, 3 source(s), and sufficient coverage. Signal extraction identifies general intelligence with weak signal quality and routing confidence of 0.2913. Opportunity discovery classifies this as a moderate validated gap opportunity with watch priority and low validation urgency. Breakthrough synthesis classifies this as opportunity candidate with incremental_opportunity synthesis strength and weak non-obviousness. Technical feasibility classifies this as early feasibility with early 
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-01T05:09:21.741235+00:00",
  "ingestion_contract": {
    "coverage_level": "sufficient",
    "domain": "technology",
    ...
    "safe_for_downstream_scoring": fal
... [truncated]
```
...
```json
{
  ...
  "evidence_gaps": [
    ...
    },
    {
      ...
      "why_it_matters": "The opportunity needs stronger proof th
... [truncated]
```
...
```json
{
  "breakthrough_score": 0.8422336823385653,
  "innovation_score": 0.6789356103874743,
  "interpretation": "This run is classified as a promising breakthrough candidate. Breakthrough spike contribution was 0.2370; market pressure contribution was 0.3896; trajectory inevitability was 0.5763; category creation was 0.5889; buyer pull was 0.5412; moat score was 0.3808; risk score was 0.2319; value capture was 0.5208; buyer ROI was 0.4507.",
  "signal_trace": {
    "acquirer_positioning_score": 0.8746,
    "analysis": 0.4383832905540869,
    "architecture_readiness_score": 0.485,
    "blocker_level": "low",
    "breakthrough_base": 0.5893182402883989,
    "breakthrough_final": 0.8422336823385653,
    "breakthrough_mechanism_score": 0.5363,
    "breakthrough_spike": 0.23700000000000002,
    "breakthrough_synthesis_confidence": 0.6179,
    "breakthrough_synthesis_score": 0.6217,
    "business_model_confidence": 0.5529,
    "buyer_pull_score": 0.5412,
    "buyer_roi_score": 0.4507,
    "category_creation_score": 0.5889,
    "commercial_risk_score": 0.1981,
    "control_signal_score": 0.06,
    "copy_risk_score": 0.4114,
    "coverage_score": 0.6547,
    "data_readiness_score": 0.3073,
...
```json
{
  "buildability_score": 0.6559428517675564,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.6578819485783239,
  "readiness": {},
...
```json
{
  "acquisition_score": 0.6489981995895997,
  "matching_score": 0.6505890697143214,
  "portfolio_score": 0.696429200514279,
