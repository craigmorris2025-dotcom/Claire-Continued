...
```json
{
  ...
  "ingested_at": "2026-05-06T13:33:49.649525+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "insurance",
...
```json
{
  ...
  "breakthrough_thesis": "climate insurance is classified as a innovation candidate. The breakthroug
... [truncated]
```
...
```json
{
  ...
  "innovation_score": 0.8352701257787501,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.2670; market pressure contribution was 0.5096; trajectory inevitability was 0.6582; category creation was 0.7824; buyer pull was 0.6801; moat score was 0.5412; risk score was 0.3941; value capture was 0.6142; buyer ROI was 0.5154.",
  "signal_trace": {
    "acquirer_positioning_score": 0.98,
    "analysis": 0.9095325760829623,
    "architecture_readiness_score": 0.5523,
    "blocker_level": "low",
    "breakthrough_base": 0.7629288116383223,
    "breakthrough_final": 0.9440000000000001,
    "breakthrough_mechanism_score": 0.6256,
    "breakthrough_spike": 0.267,
    "breakthrough_synthesis_confidence": 0.7145,
    "breakthrough_synthesis_score": 0.7403,
    "business_model_confidence": 0.6432,
    "buyer_pull_score": 0.6801,
    "buyer_roi_score": 0.5154,
    "category_creation_score": 0.7824,
    "commercial_risk_score": 0.2221,
    "control_signal_score": 0.17,
    "copy_risk_score": 0.33,
    "coverage_score": 0.9307,
    "data_readiness_score": 0.3486,
    "deal_exit_confidenc
... [truncated]
```
...
```json
{
  "buildability_score": 0.7518458631814522,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.7412300940975953,
  "readiness": {
    "breakthrough": 0.9440000000000001,
    "feasibility": 0.7412300940975953,
    "portfolio": 0.8021598417463164,
...
```json
{
  "acquisition_score": 0.7525519171647489,
  "matching_score": 0.7564117105864939,
  "portfolio_score": 0.8021598417463164,
  "positioning": "This opportunity is positioned in climate insurance. It addresses the needed solution: Climate insurance risk intelligence platform that detects exposure concentration, forecasts repricing pressure, and supports underwriting, risk-transfer, and portfolio countermeasures. Primary buyer segments include insurers, reinsurers, underwriting teams. The trend trajectory is rising, with a watch and prepare strategic window. Market formation profile: platform layer at early adoption stage. Defensibility is emerging, led by data advantage. Risk profile is low, regulatory exposure is low, and blocker level is low. Business model fit is enterprise subscription with moderate value capture. Deal/exit position is exit candidate with strong strategic fit and strategic with validation valuation signal."
}
```
