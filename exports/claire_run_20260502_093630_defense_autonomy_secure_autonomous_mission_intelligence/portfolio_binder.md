...
{
  "key_scores": {
    "breakthrough": 0.7910975559595005,
    "confidence": 0.6290473124723821,
    "feasibility": 0.5900759268885148,
    "knowledge_quality": 0.5721,
    "portfolio": 0.6290473124723821,
    "productization": 0.4048,
    "signal_quality": 0.2745,
    "strategic_positioning": 0.5106
  },
...
```json
{
  ...
  "ingested_at": "2026-05-02T09:36:30.172235+00:00",
  "ingestion_contract": {
    "coverage_level": "sufficient",
    "domain": "technology",
...
```json
{
  ...
  "breakthrough_thesis": "defense autonomy is classified as a opportunity candidate. The breakthrough mechanism is: convert sensor and mission context into authorized, explainable, and simulation-backed deci
... [truncated]
```
...
```json
{
  "breakthrough_score": 0.7910975559595005,
  "innovation_score": 0.6563845502210949,
  ...
  "signal_trace": {
    ...
    "architecture_readiness_score": 0.5544,
    "blocker_level": "conditional",
    "breakthrough_base": 0.5857655047464758,
    "breakthrough_final": 0.7910975559595005,
    "breakthrough_mechanism_score": 0.546,
    "breakthrough_spike": 0.185,
    "breakthrough_synthesis_confidence": 0.6145,
    "breakthrough_synthesis_score": 0.6006,
...
```json
{
  "buildability_score": 0.6084851466674566,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.5900759268885148,
  "readiness": {},
...
```json
{
  "acquisition_score": 0.5943429569981779,
  "matching_score": 0.5968099089371552,
  "portfolio_score": 0.6290473124723821,
