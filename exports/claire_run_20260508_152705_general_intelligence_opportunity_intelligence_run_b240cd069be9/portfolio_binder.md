...
{
  "key_scores": {
    "breakthrough": 0.9189776031437573,
    "confidence": 0.6982377559785546,
    "feasibility": 0.6791333306953042,
    "knowledge_quality": 0.7028,
    "portfolio": 0.6982377559785546,
    "productization": 0.463,
    "signal_quality": 0.4212,
    "strategic_positioning": 0.5228
  },
  "summary": "Claire identified a opportunity intelligence platform opportunity. Organizations lack integrated systems for detecting weak signals, synthesizing opportunities, and converting them into validated designs. The needed solution is: Cross-sector opportunity intelligence platform that maps signals, gaps, opportunities, designs, and strategic outcomes. Knowledge ingestion is usable with score 0.7028, 3 source(s), and broad coverage. Signal extraction identifies general intelligence with thin signal quality and routing confidence of 0.25. Opportunity discovery classifies this as a moderate validated gap opportunity with watch priority and low validation urgency. Breakthrough synthesis classifies this as opportunity candidate with incremental_opportunity synthesis strength and weak non-obviousness. Technical feasibility classifies this as early feasibility with early feasibi
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-08T15:27:05.523405+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "general",
...
```json
{
  ...
  "recommended_downstream_attention": [
    {
      "area": "input quality",
      "downstream_use": "treat discovery and breakthrough c
... [truncated]
```
...
```json
{
  ...
  "inflection_signals": {
    ...
    "signals": [
      ...
      "legacy or reactive market structure"
    ]
  },
...
```json
{
  "breakthrough_score": 0.9189776031437573,
  "innovation_score": 0.7608417874591383,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.2370; market pressure contribution was 0.3896; trajectory inevitability was 0.5363; category creation was 0.5817; buyer pull was 0.5356; moat score was 0.3346; risk score was 0.2319; value capture was 0.5124; buyer ROI was 0.4465.",
  "signal_trace": {
    "acquirer_positioning_score": 0.8746,
    "analysis": 0.9095325760829623,
    "architecture_readiness_score": 0.5094,
    "blocker_level": "low",
    "breakthrough_base": 0.6733904572640916,
    "breakthrough_final": 0.9189776031437573,
    "breakthrough_mechanism_score": 0.5253,
    "breakthrough_spike": 0.23700000000000002,
    "breakthrough_synthesis_confidence": 0.6203,
    "breakthrough_synthesis_score": 0.6219,
    "business_model_confidence": 0.5456,
    "buyer_pull_score": 0.5356,
    "buyer_roi_score": 0.4465,
    "category_creation_score": 0.5817,
    "commercial_risk_score": 0.2004,
    "control_signal_score": 0.06,
    "copy_risk_score": 0.4785,
    "coverage_score": 0.9286,
    "data_readiness_score": 0.2847,
    "d
... [truncated]
```
...
```json
{
  "buildability_score": 0.6839067934217422,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.6791333306953042,
  "readiness": {},
...
```json
{
  "acquisition_score": 0.6579085497166107,
  "matching_score": 0.6704930091619192,
  "portfolio_score": 0.6982377559785546,
