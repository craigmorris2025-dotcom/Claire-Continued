...
{
  "key_scores": {
    "breakthrough": 0.9236896276861519,
    "confidence": 0.7155946501287301,
    "feasibility": 0.6883348512840508,
    "knowledge_quality": 0.7283,
    "portfolio": 0.7155946501287301,
    "productization": 0.5563,
    "signal_quality": 0.4562,
    "strategic_positioning": 0.5975
  },
...
```json
{
  ...
  "ingested_at": "2026-05-06T15:21:56.878439+00:00",
  "ingestion_contract": {
    "coverage_level": "broad",
    "domain": "general",
...
```json
{
  ...
  "breakthrough_thesis": "general intelligence is classified as a innovation candidate. The breakthrough mechanism is: convert fragmented signals into validated opportunity and design pathways The non-obvious pattern is: valuable opportunities can emerge from signal combinations that are
... [truncated]
```
    ...
    "top_matches": [
      {
        ...
        "rationale": [
          ...
          "focus areas match opportunity requiremen
... [truncated]
```
...
```json
{
  "breakthrough_score": 0.9236896276861519,
  "innovation_score": 0.7723317006917115,
  "interpretation": "This run is classified as a high-conviction breakthrough. Breakthrough spike contribution was 0.2370; market pressure contribution was 0.3896; trajectory inevitability was 0.5763; category creation was 0.6489; buyer pull was 0.5412; moat score was 0.3845; risk score was 0.2319; value capture was 0.5285; buyer ROI was 0.4507.",
  "signal_trace": {
    "acquirer_positioning_score": 0.8926,
    "analysis": 0.9095325760829623,
    "architecture_readiness_score": 0.4909,
    "blocker_level": "low",
    "breakthrough_base": 0.6880651926756134,
    "breakthrough_final": 0.9236896276861519,
    "breakthrough_mechanism_score": 0.5467,
    "breakthrough_spike": 0.23700000000000002,
    "breakthrough_synthesis_confidence": 0.6381,
    "breakthrough_synthesis_score": 0.6534,
    "business_model_confidence": 0.5606,
    "buyer_pull_score": 0.5412,
    "buyer_roi_score": 0.4507,
    "category_creation_score": 0.6489,
    "commercial_risk_score": 0.198,
    "control_signal_score": 0.06,
    "copy_risk_score": 0.4453,
    "coverage_score": 0.9479,
    "data_readiness_score": 0.3075,
    "de
... [truncated]
```
...
```json
{
  ...
  "needed_solution": "Cross-sector opportunity intelligence platform that maps signals, gaps, opportunities, designs, and strategic outcomes.",
  "performance_targets": {
    "breakthrough_intensity": 0.9237,
    "feasibility_threshold": 0.6883,
    "portfolio_confidence": 0.7156
  },
...
```json
{
  "buildability_score": 0.6932527128253412,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.6883348512840508,
  "readiness": {
    "breakthrough": 0.9236896276861519,
    "feasibility": 0.6883348512840508,
    "portfolio": 0.7155946501287301,
...
```json
{
  "acquisition_score": 0.6729949480361688,
  "matching_score": 0.6823980545396523,
  "portfolio_score": 0.7155946501287301,
