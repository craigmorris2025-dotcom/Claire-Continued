...
```json
{
  ...
  "evidence_signals": {
    ...
    "formation_type_score": 0.9052,
    "inevitability_score": 0.7312,
    "input_pain_term_count": 5,
    "input_proof_term_c
... [truncated]
```
