...
{
  "key_scores": {
    "breakthrough": 0.8657520891697885,
    "confidence": 0.6865325081159692,
    "feasibility": 0.63395093744434,
    "knowledge_quality": 0.5721,
    "portfolio": 0.6865325081159692,
    "productization": 0.4103,
    "signal_quality": 0.2745,
    "strategic_positioning": 0.5125
  },
  "summary": "Claire identified a distributed autonomous decision platform opportunity. Defense operators need secure, human-reviewed autonomy and mission intelligence under contested, low-latency conditions. The needed solution is: Distributed autonomous decision platform with secure command integration, simulation data, auditability, and human override controls. Knowledge ingestion is usable with score 0.5721, 3 source(s), and sufficient coverage. Signal extraction identifies general intelligence with weak signal quality and routing confidence of 0.2913. Opportunity discovery classifies this as a moderate validated gap opportunity with watch priority and moderate validation urgency. Breakthrough synthesis classifies this as opportunity candidate with incremental_opportunity synthesis strength and weak non-obviousness. Technical feasibility classifies this as needs control burndow
... [truncated]
```
...
```json
{
  ...
  "ingested_at": "2026-05-05T11:55:57.866678+00:00",
  "ingestion_contract": {
    "coverage_level": "sufficient",
    "domain": "technology",
...
```json
{
  ...
  "breakthrough_thesis": "defense autonomy is classified as a opportunity candidate. The breakthrough mechanism is: convert sensor and mission context into authorized, explainable, and simulation-backed decision suppor
... [truncated]
```
...
```json
{
  "breakthrough_score": 0.8657520891697885,
  "innovation_score": 0.7307496094028749,
  ...
  "signal_trace": {
    ...
    "architecture_readiness_score": 0.5618,
    "blocker_level": "conditional",
    "breakthrough_base": 0.6669954506804238,
    "breakthrough_final": 0.8657520891697885,
    "breakthrough_mechanism_score": 0.546,
    "breakthrough_spike": 0.185,
    "breakthrough_synthesis_confidence": 0.6238,
    "breakthrough_synthesis_score": 0.6107,
...
```json
{
  "buildability_score": 0.6547585687661674,
  "commercial_risk": "low",
  ...
  "feasibility_score": 0.63395093744434,
  "readiness": {},
...
```json
{
  "acquisition_score": 0.6199891984979998,
  "matching_score": 0.6297964412801156,
  "portfolio_score": 0.6865325081159692,
