...
```json
{
  ...
  "pilot_mode": "paid pilot_with_roi_instrumentation",
...
```json
{
  ...
  "primary_package": "Controlled Pilot"
}
```
...
```json
{
  ...
  "launch_mode": "paid pilot_with_roi_instrumentation"
}
```
...
```json
"climate insurance is pilot_ready with pilot_ready productization strength and a score of 0.7569. The recommended motion is ROI-instrumented design-partner pilot with launch posture paid pilot_with_roi_instrumentation. Productization should focus on a narrow product wedge, measurable buyer value, workflow adoption, and evidence gates before enterprise expansion."
```
