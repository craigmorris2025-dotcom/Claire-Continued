...
def classify_route(route: Any) -> dict:
    ...
    return {"path": getattr(route, "path", ""), "name": getattr(route, "name", ""), "methods": methods, "read_only": all(method in READ_ONLY_CLASSIFICATIONS for method in methods), "operation_id": getattr(route, "operation_id", None)}
