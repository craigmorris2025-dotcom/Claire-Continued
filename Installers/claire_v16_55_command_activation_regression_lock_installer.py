...
write("tests/runtime/test_v16_55_command_activation_regression.py", r"""
import json
from pathlib import Path
...
print("v16.55 command activation regression lock installed.")
print("Run: pytest tests/runtime/test_v16_55_command_activation_regression.py")
