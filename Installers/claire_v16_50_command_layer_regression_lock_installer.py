...
write("tests/runtime/test_v16_50_command_layer_regression.py", r"""
...
print("v16.50 command layer regression lock installed.")
print("Run: pytest tests/runtime/test_v16_50_command_layer_regression.py")
