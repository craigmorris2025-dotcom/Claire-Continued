# Claire Syntalion v16.48_runtime_command_dispatcher installer
...
$Files = @(
  @{ Source = "payload\src/claire/runtime/runtime_command_dispatcher.py"; Dest = "src/claire/runtime/runtime_command_dispatcher.py" },
  @{ Source = "payload\tests/regression/test_v16_48_runtime_command_dispatcher.py"; Dest = "tests/regression/test_v16_48_runtime_command_dispatcher.py" }
)
...
$ManifestPath = Join-Path $InstallManifestDir "v16.48_runtime_command_dispatcher.json"
$Manifest = @{
  version = "v16.48_runtime_command_dispatcher"
...
Write-Host "v16.48_runtime_command_dispatcher install complete." -ForegroundColor Cyan
