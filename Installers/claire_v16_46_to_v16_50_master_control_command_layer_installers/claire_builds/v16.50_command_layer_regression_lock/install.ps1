# Claire Syntalion v16.50_command_layer_regression_lock installer
...
$Files = @(
  @{ Source = "payload\src/claire/runtime/command_layer_regression_lock.py"; Dest = "src/claire/runtime/command_layer_regression_lock.py" },
  @{ Source = "payload\tests/regression/test_v16_50_command_layer_regression_lock.py"; Dest = "tests/regression/test_v16_50_command_layer_regression_lock.py" }
)
...
$ManifestPath = Join-Path $InstallManifestDir "v16.50_command_layer_regression_lock.json"
$Manifest = @{
  version = "v16.50_command_layer_regression_lock"
...
Write-Host "v16.50_command_layer_regression_lock install complete." -ForegroundColor Cyan
