# Claire Syntalion v16.46_master_control_ui_shell installer
...
$Files = @(
  @{ Source = "payload\src/claire/ui/master_control_ui_shell.py"; Dest = "src/claire/ui/master_control_ui_shell.py" },
  @{ Source = "payload\src/claire/api/routes_master_control_ui.py"; Dest = "src/claire/api/routes_master_control_ui.py" },
  @{ Source = "payload\tests/regression/test_v16_46_master_control_ui_shell.py"; Dest = "tests/regression/test_v16_46_master_control_ui_shell.py" }
)
...
$ManifestPath = Join-Path $InstallManifestDir "v16.46_master_control_ui_shell.json"
$Manifest = @{
  version = "v16.46_master_control_ui_shell"
...
Write-Host "v16.46_master_control_ui_shell install complete." -ForegroundColor Cyan
