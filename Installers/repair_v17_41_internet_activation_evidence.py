# Claire v17.41 Internet Activation Repair
# Fixes SyntaxError in src/claire/internet_activation/evidence.py
#
# Place this file in Claire project root and run:
#
#     python repair_v17_41_internet_activation_evidence.py
#
# Then rerun:
#
...
TARGET = ROOT / "src" / "claire" / "internet_activation" / "evidence.py"
...
def main() -> None:
    if not TARGET.parent.exists():
        raise SystemExit(f"Missing folder: {TARGET.parent}")
