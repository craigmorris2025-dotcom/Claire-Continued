...
write("tests/live/test_v16_65_live_intelligence_regression.py", r"""
from pathlib import Path
...
print("v16.65 live intelligence regression lock installed.")
print("Run: pytest tests/live/test_v16_65_live_intelligence_regression.py")
