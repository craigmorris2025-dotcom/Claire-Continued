...
write("tests/memory/test_v16_70_continuity_regression.py", r"""
from pathlib import Path
...
print("v16.70 continuity regression lock installed.")
print("Run: pytest tests/memory/test_v16_70_continuity_regression.py")
