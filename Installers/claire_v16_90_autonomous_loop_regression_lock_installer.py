...
write("tests/autonomy/test_v16_90_autonomous_loop_regression.py", r"""
from pathlib import Path
...
print("v16.90 autonomous loop regression lock installed.")
print("Run: pytest tests/autonomy/test_v16_90_autonomous_loop_regression.py")
