...
def test_s562_panel_registry_covers_update_runway():
    module = importlib.import_module("claire.api.claire_update_control_cockpit_wiring_s562_s568")
...
def test_s562_s568_rollup_ready():
    ...
    rollup = module.build_claire_update_control_cockpit_wiring_s562_s568(project_root=Path.cwd())
