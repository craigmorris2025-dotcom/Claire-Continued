...
def _passed_review_packet():
    plan_module = importlib.import_module("claire.api.claire_controlled_update_validation_plan_s520_s526")
    intake_module = importlib.import_module("claire.api.claire_validation_result_intake_s534_s540")
...
def test_s541_schema_is_ready_and_safe():
    module = importlib.import_module("claire.api.claire_update_promotion_decision_packet_s541_s547")
...
def test_s541_s547_rollup_ready():
    ...
    rollup = module.build_claire_update_promotion_decision_packet_s541_s547(project_root=Path.cwd())
