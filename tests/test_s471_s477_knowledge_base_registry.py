...
def test_s471_registry_contains_uploaded_document_knowledge_base():
    module = importlib.import_module("runtime_core.api.knowledge_base_registry_s471_s477")
...
def test_registry_exports_evidence_sources_compatible_with_s464():
    module = importlib.import_module("runtime_core.api.knowledge_base_registry_s471_s477")
    evidence_model = importlib.import_module("runtime_core.api.evidence_backed_answer_model_s464_s470")
...
def test_s471_s477_rollup_ready():
    ...
    rollup = module.build_knowledge_base_registry_s471_s477(project_root=Path.cwd())
