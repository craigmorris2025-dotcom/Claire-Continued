...
def test_s520_authority_matrix_blocks_execution():
    module = importlib.import_module("claire.api.claire_controlled_update_validation_plan_s520_s526")
...
def test_s520_s526_rollup_ready():
    ...
    rollup = module.build_claire_controlled_update_validation_plan_s520_s526(project_root=Path.cwd())
