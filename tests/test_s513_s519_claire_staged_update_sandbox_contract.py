...
def test_s513_sandbox_profile_contract_and_builder_are_safe():
    module = importlib.import_module("claire.api.claire_staged_update_sandbox_contract_s513_s519")
...
def test_s514_file_impact_map_detects_protected_paths_without_writes():
    module = importlib.import_module("claire.api.claire_staged_update_sandbox_contract_s513_s519")
    inspector = importlib.import_module("claire.api.claire_governed_update_inspector_s506_s512")
...
def test_s513_s519_rollup_ready():
    ...
    rollup = module.build_claire_staged_update_sandbox_contract_s513_s519(project_root=Path.cwd())
