...
def test_root_launcher_uses_safe_python_module_invocation_and_operational_dashboard():
    ...
    assert "http://%CLAIRE_HOST%:%CLAIRE_PORT%/dashboard" in text
    assert "http://%CLAIRE_HOST%:%CLAIRE_PORT%/dashboard/v5" not in text
