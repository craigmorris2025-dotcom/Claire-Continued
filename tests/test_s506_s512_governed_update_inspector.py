...
def test_s506_manifest_schema_is_ready_and_safe():
    module = importlib.import_module("runtime_core.api.governed_update_inspector_s506_s512")
...
def test_s506_s512_rollup_ready():
    ...
    rollup = module.build_governed_update_inspector_s506_s512(project_root=Path.cwd())
