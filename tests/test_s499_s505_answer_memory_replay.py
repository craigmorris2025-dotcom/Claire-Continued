...
def test_s499_memory_schema_is_ready_and_safe():
    module = importlib.import_module("runtime_core.api.answer_memory_replay_s499_s505")
...
def test_s500_build_answer_memory_record_from_preview():
    module = importlib.import_module("runtime_core.api.answer_memory_replay_s499_s505")
    preview_module = importlib.import_module("runtime_core.api.useful_output_package_preview_s492_s498")
...
def test_s499_s505_rollup_ready():
    ...
    rollup = module.build_answer_memory_replay_s499_s505(project_root=Path.cwd())
