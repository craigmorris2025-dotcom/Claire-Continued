...
def test_s464_evidence_source_schema_and_default_sources():
    module = importlib.import_module("claire.api.claire_evidence_backed_answer_model_s464_s470")
...
def test_s464_s470_rollup_ready():
    ...
    rollup = module.build_claire_evidence_backed_answer_model_s464_s470(project_root=Path.cwd())
