...
def test_local_fallback_dashboard_fetches_operational_file_readiness():
    dashboard_js = "frontend/command_center/modern/platform_dashboard.js"
...
def test_route_integrity_reports_dashboard_payload_owner_state():
    ...
    assert payload["dashboard_payload"]["canonical_owner"]["module"] in {
        "runtime_core.app",
        "runtime_core.app",
        "runtime_core.api.dashboard_payload_bridge",
    }
