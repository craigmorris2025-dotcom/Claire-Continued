...
def test_s548_schema_is_ready_and_safe():
    module = importlib.import_module("claire.api.claire_rollback_recovery_gate_s548_s554")
...
def test_s548_s554_rollup_ready():
    ...
    rollup = module.build_claire_rollback_recovery_gate_s548_s554(project_root=Path.cwd())
