...
def test_s527_evidence_item_schema_and_item_are_safe():
    module = importlib.import_module("claire.api.claire_update_evidence_review_queue_s527_s533")
...
def test_s527_s533_rollup_ready():
    ...
    rollup = module.build_claire_update_evidence_review_queue_s527_s533(project_root=Path.cwd())
