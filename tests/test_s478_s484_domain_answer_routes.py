...
def test_s478_s480_route_contracts_exist_and_are_safe():
    module = importlib.import_module("runtime_core.api.domain_answer_routes_s478_s484")
...
def test_s478_s484_rollup_ready():
    ...
    rollup = module.build_domain_answer_routes_s478_s484(project_root=Path.cwd())
