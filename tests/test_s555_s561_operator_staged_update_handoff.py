...
def test_s555_approval_text_contract_and_evaluation_are_safe():
    module = importlib.import_module("runtime_core.api.operator_staged_update_handoff_s555_s561")
...
def test_s555_s561_rollup_ready():
    ...
    rollup = module.build_operator_staged_update_handoff_s555_s561(project_root=Path.cwd())
