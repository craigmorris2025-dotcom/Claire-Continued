...
def test_s611_source_intake_payload_preserves_blocked_authority():
    module = importlib.import_module("claire.governance.governed_source_evidence_intake")
...
def test_s618_query_compiler_builds_plan_without_execution():
    module = importlib.import_module("claire.governance.governed_query_compiler")
...
def test_s620_route_modules_expose_expected_paths():
    intake_routes = importlib.import_module("claire.api.governed_source_evidence_intake_routes")
    compiler_routes = importlib.import_module("claire.api.governed_query_compiler_routes")
...
def test_s624_combined_payloads_are_cockpit_ready():
    intake = importlib.import_module("claire.governance.governed_source_evidence_intake")
    compiler = importlib.import_module("claire.governance.governed_query_compiler")
