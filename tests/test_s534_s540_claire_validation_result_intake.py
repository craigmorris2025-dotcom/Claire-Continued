...
def test_s534_schema_and_result_records_are_safe():
    module = importlib.import_module("claire.api.claire_validation_result_intake_s534_s540")
...
def test_s534_s540_rollup_ready():
    ...
    rollup = module.build_claire_validation_result_intake_s534_s540(project_root=Path.cwd())
