...
from runtime_core.api.internet_proposal_review_export_action_s380_s386 import (
...
def test_s383_export_action_writes_export_files(tmp_path, monkeypatch):
    import runtime_core.api.internet_proposal_review_export_action_s380_s386 as module
