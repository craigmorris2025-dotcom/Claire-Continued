...
def test_s569_schema_preserves_current_plan_and_web_handoff():
    module = importlib.import_module("claire.api.claire_governed_update_readiness_demo_s569_s575")
...
def test_s569_s575_rollup_ready():
    ...
    rollup = module.build_claire_governed_update_readiness_demo_s569_s575(project_root=Path.cwd())
