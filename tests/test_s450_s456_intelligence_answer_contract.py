...
def test_s450_question_classifier_routes_core_domains():
    module = importlib.import_module("runtime_core.api.intelligence_answer_contract_s450_s456")
...
def test_s450_s456_rollup_ready():
    ...
    rollup = module.build_intelligence_answer_contract_s450_s456(project_root=Path.cwd())
