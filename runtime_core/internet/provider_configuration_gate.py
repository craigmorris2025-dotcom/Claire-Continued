...
def build_provider_template(root: Path) -> Dict[str, Any]:
    template = {
        ...
        "created_at": now(),
        "instructions": [
            "Choose exactly one provider by setting PLATFORM_SEARCH_PROVIDER in your environment or .env.",
        ...
        "required_environment_variables": {
            "PLATFORM_SEARCH_PROVIDER": "one of: none, brave, bing, serpapi, tavily",
            "BRAVE_SEARCH_API_KEY": "required only if PLATFORM_SEARCH_PROVIDER=brave",
            "BING_SEARCH_API_KEY": "required only if PLATFORM_SEARCH_PROVIDER=bing",
            "SERPAPI_API_KEY": "required only if PLATFORM_SEARCH_PROVIDER=serpapi",
            "TAVILY_API_KEY": "required only if PLATFORM_SEARCH_PROVIDER=tavily",
        },
    ...
    env_example = """# Platform Internet Provider Example
# Do not paste real API keys into ChatGPT.
# Copy needed lines into your local .env only.

PLATFORM_SEARCH_PROVIDER=none

# Choose one provider later:
# PLATFORM_SEARCH_PROVIDER=brave
# BRAVE_SEARCH_API_KEY=your_key_here

# PLATFORM_SEARCH_PROVIDER=bing
# BING_SEARCH_API_KEY=your_key_here

# PLATFORM_SEARCH_PROVIDER=serpapi
# SERPAPI_API_KEY=your_key_here

# PLATFORM_SEARCH_PROVIDER=tavily
...
def build_internet_provider_gate(project_root: Optional[Path | str] = None) -> Dict[str, Any]:
    ...
    gate = {
        ...
        "next": [
            "Set PLATFORM_SEARCH_PROVIDER and matching API key locally if desired",
