...
def _safe_import_handshake(request: Mapping[str, Any]) -> Dict[str, Any]:
    try:
        from runtime_core.governance.governed_web.live_connectivity_handshake import (
...
def _safe_import_review_record(handshake: Mapping[str, Any]) -> Dict[str, Any]:
    try:
        from runtime_core.governance.governed_web.live_connectivity_handshake_review_record import (
