"""
Autonomous Decision Engine (Loop 8) — cross-cutting gate decisions

Version: 6.2.0
Module: src.claire.intelligence.autonomous_decision
...
logger = logging.getLogger("claire.intelligence")
...
class AutonomousDecision:
    ...
    def __init__(self):
        self.logger = logging.getLogger(
            f"claire.intelligence.{type(self).__name__}"
        )
