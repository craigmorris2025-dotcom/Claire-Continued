...
from .canonical_paths import BREAKTHROUGH_DESIGN_ROUTE, route_path
...
def stage_contracts() -> Dict[str, StageContract]:
    return {
        ...
        "competitor_analysis": StageContract("competitor_analysis", ["market_formation"]),
...
def route_requires_contract(contract: StageContract, route: str) -> bool:
    if contract.optional:
        return False
    return contract.stage_id in set(route_path(route))
