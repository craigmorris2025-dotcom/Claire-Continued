...
POWERSHELL_PROFILE: List[str] = [
    '$env:PLATFORM_SEARCH_PROVIDER="manual_stub"',
    '$env:PLATFORM_ALLOW_CONTROLLED_HEAD_PROBE="true"',
    '$env:PLATFORM_ALLOW_ONE_SHOT_METADATA_PROBE="true"',
    '$env:PLATFORM_ALLOW_CONTROLLED_METADATA_GET="false"',
    'python main.py',
]

CMD_PROFILE: List[str] = [
    'set PLATFORM_SEARCH_PROVIDER=manual_stub',
    'set PLATFORM_ALLOW_CONTROLLED_HEAD_PROBE=true',
    'set PLATFORM_ALLOW_ONE_SHOT_METADATA_PROBE=true',
    'set PLATFORM_ALLOW_CONTROLLED_METADATA_GET=false',
    'python main.py',
]
