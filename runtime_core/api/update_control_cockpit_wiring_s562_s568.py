...
UPDATE_CONTROL_RUNWAY: List[Dict[str, str]] = [
    {
        ...
        "module": "runtime_core.api.governed_update_inspector_s506_s512",
        "label": "Governed update inspector",
        "owner": "metadata_inspection",
    },
    {
        "stage_range": "S513-S519",
        "module": "runtime_core.api.staged_update_sandbox_contract_s513_s519",
        "label": "Staged update sandbox contract",
        "owner": "sandbox_contract",
    },
    {
        "stage_range": "S520-S526",
        "module": "runtime_core.api.controlled_update_validation_plan_s520_s526",
        "label": "Controlled validation plan",
        "owner": "validation_plan",
    },
    {
        "stage_range": "S527-S533",
        "module": "runtime_core.api.update_evidence_review_queue_s527_s533",
        "label": "Update evidence review queue",
        "owner": "review_queue",
    },
    {
        "stage_range": "S534-S540",
        "module": "runtime_core.api.validation_result_intake_s534_s540",
        "label": "Validation result intake",
        "owner": "result_intake",
    },
    {
        "stage_range": "S541-S547",
        "module": "runtime_core.api.update_promotion_decision_packet_s541_s547",
        "label": "Promotion decision packet",
        "owner": "promotion_packet",
    },
    {
        "stage_range": "S548-S554",
        "module": "runtime_core.api.rollback_recovery_gate_s548_s554",
        "label": "Rollback recovery gate",
        "owner": "rollback_gate",
    },
    {
        "stage_range": "S555-S561",
        "module": "runtime_core.api.operator_staged_update_handoff_s555_s561",
...
def build_update_control_cockpit_wiring_s562_s568(project_root: str | Path | None = None) -> Dict[str, Any]:
    return _safe_base(
        "S562-S568",
...
__all__ = [
    ...
    "build_update_control_cockpit_wiring_s562_s568",
]
