...
PROVIDER_GATE_ENV = "PLATFORM_ALLOW_GOVERNED_LIVE_METADATA_PROBE"
HEAD_GATE_ENV = "PLATFORM_ALLOW_HEAD_ONLY_PROBE"
BODY_READ_ENV = "PLATFORM_ALLOW_RESPONSE_BODY_READ"
RUNTIME_MUTATION_ENV = "PLATFORM_ALLOW_RUNTIME_TRUTH_MUTATION"
AUTONOMOUS_ENV = "PLATFORM_ALLOW_AUTONOMOUS_EXECUTION"
...
async def _head_metadata_only(url: str) -> dict[str, Any]:
    ...
    def do_request() -> dict[str, Any]:
        ...
        try:
            conn.request("HEAD", path, headers={"User-Agent": "Platform-Governed-Metadata-Probe/1.0"})
