...
CAPSULE_SCRIPT = "\\n".join([
    ...
    "    candidates = [args.queue_id, args.approval_queue_id, args.review_queue_id, payload.get('queue_id'), payload.get('approval_queue_id'), payload.get('review_queue_id'), os.environ.get('PLATFORM_S37_QUEUE_ID'), os.environ.get('PLATFORM_QUEUE_ID')]",
