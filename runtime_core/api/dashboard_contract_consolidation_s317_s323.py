...
def build_s317_canonical_payload_extension_registry() -> Dict[str, Any]:
    sections = {
        "governed_internet_update_foundation": {
            "owner": "runtime_core.api.governed_internet_update_foundation_s296_s302",
        ...
        "governed_fetch_evidence_pipeline": {
            "owner": "runtime_core.api.governed_fetch_evidence_pipeline_s303_s309",
        ...
        "governed_update_proposal_pipeline": {
            "owner": "runtime_core.api.governed_update_proposal_pipeline_s310_s316",
