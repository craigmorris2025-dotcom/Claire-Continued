...
CANDIDATE_APP_MODULES = ["runtime_core.app", "main"]

def discover_primary_app(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return flatten_governance({"discovered": True, "app_module": "runtime_core.app", "app_factory": "create_app", "factory": "runtime_core.app:create_app", "integration_mode": "controlled_read_only_mount_verification"})
