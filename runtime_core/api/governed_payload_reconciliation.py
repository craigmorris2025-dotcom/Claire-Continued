...
from runtime_core.api._s43_governance import build_governance, flatten_governance
...
try:
    from runtime_core.api._s43_governance import flatten_compat, build_authority_block, build_compat_governance
except Exception:
