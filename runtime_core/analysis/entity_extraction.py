"""
Entity Extraction â€” NER and entity resolution from consolidated signals

Version: 5.93.0
Module: src.claire.analysis.entity_extraction
Architecture: LOCKED at v5.90.2
Stage: 6 â€” Entity Extraction
Phase: analysis
"""
...
# Stage constants
STAGE_6_ID = 6
STAGE_6_NAME = "Entity Extraction"
...
class EntityExtraction:
    ...
    def execute(self, stage_input: dict) -> dict:
        """
        Execute Stage 6: Entity Extraction.
        ...
        self.logger.info(
            f"Stage 6 (Entity Extraction): executing"
        )
    ...
    def _process(self, stage_input: dict) -> dict:
        return build_stage_payload(6, STAGE_6_NAME, stage_input)
