"""
Gap Detection â€” identify capability and knowledge gaps

Version: 5.94.0
Module: src.claire.breakthrough.gap_detection
Architecture: LOCKED at v5.90.2
Stage: 11 â€” Gap Detection
Phase: breakthrough
...
class GapDetection:
    ...
    def execute(self, stage_input: dict) -> dict:
        """
        Execute Stage 11: Gap Detection.
        ...
        self.logger.info(
            f"Stage 11 (Gap Detection): executing"
        )
        ...
        try:
            ...
            self.logger.error(f"Stage 11 failed: {e}")
            return self._build_output(
                status="failed",
                confidence=0.0,
    ...
    def _process(self, stage_input: dict) -> dict:
        return build_stage_payload(11, STAGE_11_NAME, stage_input)
