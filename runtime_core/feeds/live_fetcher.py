...
- Disabled by default unless PLATFORM_ENABLE_LIVE_FEEDS=1.
...
class SafePublicMetadataFetcher:
    ...
    def live_enabled(self) -> bool:
        return os.environ.get("PLATFORM_ENABLE_LIVE_FEEDS", "").strip() == "1"
    ...
    def status(self) -> Dict[str, Any]:
        return {
            ...
            "enable_variable": "PLATFORM_ENABLE_LIVE_FEEDS=1",
            "limits": {
    ...
    def fetch_metadata(self, url: str) -> Dict[str, Any]:
        if not self.live_enabled():
            return {
                ...
                "title": "",
                "snippet": "",
                "warning": "Live feeds are disabled. Set PLATFORM_ENABLE_LIVE_FEEDS=1 to enable controlled public metadata fetches.",
            }
