...
class EmergenceSummary:
    ...
    signal_family_readiness: Dict[str, float] = field(default_factory=dict)
    route_guidance: str = "research_monitoring"
    root_to_current_timeline: List[Dict[str, Any]] = field(default_factory=list)
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "signal_family_readiness": self.signal_family_readiness,
            "route_guidance": self.route_guidance,
            "root_to_current_timeline": self.root_to_current_timeline,
        }
...
class ClaireResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "emergence_engine": self.data.get("emergence_engine", {}),
            ...
            "source_authority": self.data.get("source_authority", {}),
            "source_boundary": self.data.get("source_boundary", {}),
