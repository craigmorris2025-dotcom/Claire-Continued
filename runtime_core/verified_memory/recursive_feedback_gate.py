...
FEEDBACK_ELIGIBLE_ROUTES = {
    ...
    "acquisition",
    "package",
    "breakthrough_to_acquisition_package",
    "opportunity_discovery_pipeline",
    "trend_discovery_pipeline",
    "full_lifecycle_pipeline",
}

ROUTE_ALIASES = {
    "portfolio_creation_optimization": "portfolio",
    "portfolio_only": "portfolio",
    "breakthrough_design": "breakthrough",
    "breakthrough_to_acquisition_package": "package",
}
...
class RecursiveFeedbackGate:
    ...
    def evaluate(self, memory_gate_report: Dict[str, Any]) -> Dict[str, Any]:
        raw_route = str(memory_gate_report.get("route_selected") or "unknown").lower()
        ...
        if route not in FEEDBACK_ELIGIBLE_ROUTES:
            ...
            reasons.append(f"Route '{raw_route}' is not currently approved for recursive feedback.")
