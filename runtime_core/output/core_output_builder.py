...
class CoreOutputBuilder:
    ...
    def build(
        ...
        output = {
            ...
            "source_boundary": data.get("source_boundary", {}),
    ...
    def _route_selected(self, core_lifecycle: Dict[str, Any], data: Dict[str, Any], scores: Dict[str, Any], status: str) -> str:
        ...
        route = core_lifecycle.get("route") or PORTFOLIO_ROUTE
        ...
        design_route_requested = thesis_route in {
            "breakthrough_design",
            "breakthrough_escalation_candidate",
            "solution_design",
        }

        if design_route_requested and design_status in {"success", "design_ready"}:
            return "solution_design"
        if thesis_route == "breakthrough_escalation_candidate":
    ...
    def _headline(
        ...
        label = trend_name or category or "market intelligence opportunity"
        ...
        if route == "breakthrough_design":
            return f"{label}: breakthrough design route"
