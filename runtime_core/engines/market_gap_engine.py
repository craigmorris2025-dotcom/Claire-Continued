...
class MarketGapEngine:
    ...
    def _sector_profile(self, sector: str) -> Dict[str, Any]:
        profiles = {
            "autonomous_invention": {
                "industry_context": "AI engineering, autonomous invention systems, patent intelligence, technology scanning, design automation",
                "gap_type": "patent mining / technology gap discovery / buildability validation",
                "market_gap": "R&D and product teams need a governed way to turn technology timelines, patent metadata, standards, repositories, and local source packs into buildable discovery and design candidates.",
                "needed_solution": "Autonomous invention intelligence layer that detects buildable gaps, maps prior art, validates manufacturability, and routes candidates into design review.",
                ...
                "design_implications": [
                    "patent mining metadata lane",
                    "technology timeline database",
                    "component combination engine",
                    "buildability and manufacturability scoring",
                    "design portal handoff",
                    "governed validation queue",
                ],
                "acquirer_categories": [
                    "AI platforms",
                    "engineering software companies",
                    "R&D intelligence platforms",
                    "IP intelligence companies",
    ...
    def _strategic_pressure(
        ...
        if sector == "climate_insurance":
            base += 0.12
        elif sector == "autonomous_invention":
            base += 0.10
