...
class OpportunityDiscoveryEngine:
    ...
    def _sector_profile(self, sector: str) -> Dict[str, Any]:
        profiles = {
            "autonomous_invention": {
                "primary_vector": "autonomous invention and technology gap discovery opportunity",
                "target_gap": "patent mining / technology gap discovery / manufacturability validation",
                "unmet_need": "autonomous invention intelligence layer",
                "solution_class": "autonomous invention intelligence layer",
                "first_buyer_segment": "R&D and engineering software teams",
                "buyer_pain": "teams need earlier recognition of buildable gaps across patents, standards, repositories, and technology timelines",
                "entry_wedge": "patent-mining gap discovery pilot",
                "expansion_path": ["local technology database", "prior-art metadata lane", "component combination engine", "manufacturability precheck", "design portal handoff"],
                "proof_to_unlock": "prior-art coverage, buildability score, manufacturability proof, and design-review acceptance",
                "white_space_area": "governed discovery layer between technology scanning, patent intelligence, and design automation",
                "incumbent_blind_spot": "research tools find documents but do not reliably synthesize buildable gap candidates into governed design routes",
                "hidden_gap": "buildable inventions can appear where existing technologies overlap but prior-art and manufacturability checks are not connected",
                "category_language": "autonomous invention intelligence",
                "buyer_validation_objective": "Confirm R&D and engineering teams need governed candidate discovery before design investment.",
                "buyer_validation_evidence": ["R&D workflow interviews", "prior-art review examples", "design decision pain evidence"],
                "historical_validation_objective": "Backtest generated candidates against known technology transitions and patent clusters.",
                "historical_validation_evidence": ["timeline backtest", "prior-art precision report", "false-positive review"],
                "workflow_validation_objective": "Confirm fit with design review, portfolio, and IP workflows.",
                "workflow_validation_evidence": ["design portal review", "engineering workflow test", "IP review notes"],
                "economic_validation_objective": "Quantify faster candidate discovery, reduced dead-end design work, or stronger IP pipeline formation.",
                "economic_validation_evidence": ["cycle-time reduction", "candidate precision", "portfolio value model"],
                "defensibility_validation_objective": "Prove source-pack memory, validation traces, and component graph history compound over time.",
                "defensibility_validation_evidence": ["source-pack lineage", "candidate memory graph", "validation history"],
                "roi_evidence": ["candidate precision", "engineering cycle-time reduction", "avoided dead-end design work"],
                "moat_evidence": ["validated source-pack memory", "component combination graph", "prior-art review history"],
                "first_action": "run prior-art and buildability review on the top candidate",
                "second_action": "route the candidate into design portal validation",
                "hypotheses": [
                    {
                        "hypothesis": "R&D teams will value a governed invention layer if it produces buildable, manufacturable candidates with prior-art context.",
                        "validation_method": "Review generated candidates against patent metadata, standards, and design feasibility.",
                        "success_signal": "Reviewers select candidates for design or portfolio packaging.",
                        "priority": "high",
                    },
                ],
            },
    ...
    def _domain_for_sector(self, sector: str, fallback: str) -> str:
        return {
            ...
            "autonomous_invention": "technology",
