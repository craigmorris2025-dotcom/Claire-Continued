    ...
    def _sector_signals(self, text: str) -> Dict[str, Any]:
        sector_terms = {
            "autonomous_invention": [
                "invention engine", "autonomous invention", "patent mining", "technology scanning",
                "technology database", "design portal", "buildable", "manufacturable",
                "component combination", "gap discovery", "breakthrough design",
            ],
            "climate_insurance": [
